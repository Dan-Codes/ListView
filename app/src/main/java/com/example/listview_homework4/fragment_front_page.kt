...
class FrontPageFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        task1.setOnClickListener {
            view.findNavController().navigate(R.id.action_frontPageFragment_to_listViewFragment)
        }
//        task2.setOnClickListener{
//            view.findNavController().navigate(R.id.action_frontPageFragment_to_viewPager_Activity)
//        }
//        task3.setOnClickListener{
//            view.findNavController().navigate(R.id.action_frontPageFragment_to_MDActivity)
//        }
